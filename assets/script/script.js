...
const inputsRessource = document.querySelectorAll(
    'input[name = "singleSelect"]'
) //инпуты опций выпадающнго списка
        ...
        if (ressource.checked == true) {
            ...
            try {
                ...
                fetch(`https://swapi.dev/api/${valueRessource}/${valueIndex}/`)
                    ...
                    .then((json) => {
                        if (json.detail == "Not found") throw new Error("Invalid number") //выброс ошибки при вводе некорректного индекса
